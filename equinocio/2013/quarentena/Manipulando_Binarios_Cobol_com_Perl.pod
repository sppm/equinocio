...
Quando criamos um arquivo binário COBOL nós temos a opção de comprimir os campos numéricos, em (tamanho + 1) / 2.

Por exemplo o número I<999787> em hexadecimal seria I<39 39 39 37 38 37>, que ocuparia 3 bytes. 

O que o comp-3 faz é o sistema inverso, ele grava I<99 97 87> hexadecimal mais uma letra que indica se o número é positivo ou negativo (tamanho + 1) / 2.
